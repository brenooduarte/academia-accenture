...
public class JogoDaVelha {
	...
	public static void main(String[] args) {
		...
		do {		
			...
			do {
				indiceLinha = Integer.parseInt(JOptionPane.showInputDialog(
						String.format("""
								Jogador %d, digite sua posição:
								Linha:""", numeroJogador)
				));

				indiceColuna = Integer.parseInt(JOptionPane.showInputDialog(
						String.format("""
								Jogador %d, digite sua posição:
								Coluna:""", numeroJogador)
				));
			...
			if (contadorJogadas == 9) {
				JOptionPane.showMessageDialog(null, "O jogo deu EMPATE!");
